...
<p> Statistical Computing 2022, July 27 </p>
</div>
]
...
+ to systematically catalogize research data resulting from publicly funded research, to secure these for the future and make them findable and accessible

+ to develop and establish standards in research-data management and guarantee the (inter-)national linkage of research data
...
+ joint publications in DMV Mitteilungen and the GAMM Newsletter

+ TA1 rolls out a first technical review process

+ TA2 implements a knowledge graph front end
+ TA3 and TA4 have internal kick-off meetings in Dec. 2021 and March 2022

+ first implementation of a formula search in the portal by TA5

+ publication of an article discussing FAIRness of their local 

+ research-data repository http://mathrepo.mis.mpg.de by TA6

+ build up of the internal consortial infrastructure by TA7


???


[Here you can add up-to-date news: publications, workshops, which events MaRDI people attended, status quo of the Portal and the webpage, one recent result of each task area, or similar. The list you currently is up-to-date as of March 2022.]

References
Internal Newsletter MaRDIgest via mardi2020 mailinglist mardi2020@listserv.dfn.de 
MaRDienstag recordings and sentences https://cloud.mardi4nfdi.de/index.php/f/1468
MaRDI Twitter https://twitter.com/mardi4nfdi
...
.pull-left[
+ Minisymposium and stall at the DMV Jahrestagung, September 2022 in Berlin

+ MaRDI-Workshop on Scientific Computing, October 2022 in Münster

+ MaRDI-Workshop on Digital Humanities and Math, November 2022 in Berlin

+ Participation in the creation of an NFDI Basisdienste-Konsortium


<br>


[www.mardi4nfdi.de](www.mardi4nfdi.de)
...
```{r, echo=FALSE}
knitr::include_graphics("figures/Postkarte-02.png")
```
...
[Here you can add yourself: milestones, workshops, presence at events, next steps for Portal/Website, one current goal of each TA, e.g.]

References
Internal Newsletter MaRDIgest via mardi2020 list mardi2020@listserv.dfn.de 
MaRDienstag recordings and sentences https://cloud.mardi4nfdi.de/index.php/f/1468
Calendar on the MaRDI Website https://www.mardi4nfdi.de/events/meetings
